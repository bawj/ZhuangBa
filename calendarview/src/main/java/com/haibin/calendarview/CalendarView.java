...
public class CalendarView extends FrameLayout {
    ...
    private MonthRecycler mMonthRecycler;
    ...
    private void init(Context context) {
        ...
        this.mMonthRecycler = (MonthRecycler) findViewById(R.id.vp_month);
        this.mMonthRecycler.mWeekPager = mWeekPager;
        this.mMonthRecycler.mWeekBar = mWeekBar;
...
//        this.mMonthPager.mWeekBar = mWeekBar;
        FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) this.mMonthRecycler.getLayoutParams();
...
//                        && mMonthRecycler.getCurrentItem() != mDelegate.mCurrentMonthViewItem) {
                        ) {
                    return;
                }
...
//                mMonthRecycler.setCurrentItem(position, false);
//                mMonthPager.updateSelected();
                if (mWeekBar != null &&
        ...
        mMonthRecycler.setup(mDelegate);
//        mMonthRecycler.setCurrentItem(mDelegate.mCurrentMonthViewItem);
...
//                closeSelectLayout(position);
    ...
    public void setRange(int minYear, int minYearMonth, int minYearDay,
        ...
        mMonthRecycler.notifyDataSetChanged();
...
//    }
    ...
    public void scrollToCurrent(boolean smoothScroll) {
        ...
        mDelegate.updateSelectCalendarScheme();
        mWeekBar.onDateSelected(mDelegate.mSelectedCalendar, mDelegate.getWeekStart(), false);
        if (mMonthRecycler.getVisibility() == VISIBLE) {
            mMonthRecycler.scrollToCurrent(smoothScroll);
            mWeekPager.updateSelected(mDelegate.mIndexCalendar, false);
        } else {
...
//        }
    ...
    public final void clearSelectRange() {
        ...
        mMonthRecycler.clearSelectRange();
    ...
    public final void clearSingleSelect() {
        mDelegate.mSelectedCalendar = new Calendar();
        mMonthRecycler.clearSingleSelect();
    ...
    public final void clearMultiSelect() {
        ...
        mMonthRecycler.clearMultiSelect();
...
//        mMonthPager.updateItemHeight();
    ...
    public final void setMonthView(Class<?> cls) {
        ...
        mMonthRecycler.updateMonthViewClass();
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (getParent() != null && getParent() instanceof CalendarLayout) {
            ...
            mMonthRecycler.mParentLayout = mParentLayout;
    ...
    public final void setSchemeDate(Map<String, Calendar> mSchemeDates) {
        ...
        this.mMonthRecycler.updateScheme();
...
//        mMonthPager.updateCurrentDate();
     ...
     * @return 获得月视图
     */
    public MonthRecycler getMonthViewPager() {
        return mMonthRecycler;
    }
