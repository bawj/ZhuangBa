 ...
 */
public class JoinTheTeamAdapter extends BaseQuickAdapter<TeamJoinedBean , BaseViewHolder> {

    public JoinTheTeamAdapter() {
        super(R.layout.item_team_join_the_team , null);
    }
    @Override
