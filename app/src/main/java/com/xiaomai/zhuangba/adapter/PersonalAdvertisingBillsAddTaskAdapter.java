 ...
 */
public class PersonalAdvertisingBillsAddTaskAdapter extends BaseQuickAdapter<AdvertisingBillsBean, BaseViewHolder> {

    public PersonalAdvertisingBillsAddTaskAdapter() {
        super(R.layout.item_personal_advertising_bills_add_task, null);
    }
