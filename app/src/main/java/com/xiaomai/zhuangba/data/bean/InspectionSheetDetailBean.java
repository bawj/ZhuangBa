...
public class InspectionSheetDetailBean {
     ...
     * modifyTime : 2019-09-29 16:48:16
     * expireTime : null
     * team : null
     * maintenanceFlag : 0
     * orderServices : []
     ...
     * slottingStartLength : week
     * slottingEndLength : 二
     * slottingPrice : 0
     * debugging : 8
     * debugPrice : 0
     * materialsStartLength : null
     * materialsEndLength : null
     * materialsPrice : 0
     * orderType : 3
     * assigner : null
     */
    ...
    public void setSlottingPrice(int slottingPrice) {
    ...
    public void setDebugPrice(int debugPrice) {
    ...
    public void setMaterialsPrice(int materialsPrice) {
