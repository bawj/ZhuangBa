 ...
 * @date 2019/8/27 0027
 */
public class EmployerAdvertisementAcceptedOrdersFragment extends BaseAdvertisementFragment {
    ...
    public static EmployerAdvertisementAcceptedOrdersFragment newInstance(String orderCode, String orderType) {
        Bundle args = new Bundle();
        args.putString(ConstantUtil.ORDER_CODE, orderCode);
        args.putString(ConstantUtil.ORDER_TYPE, orderType);
        EmployerAdvertisementAcceptedOrdersFragment fragment = new EmployerAdvertisementAcceptedOrdersFragment();
