...
/** 
 * DAO for table "MATERIALS_LIST_DB".
*/
public class MaterialsListDBDao extends AbstractDao<MaterialsListDB, Long> {

    public static final String TABLENAME = "MATERIALS_LIST_DB";

    /**
     * Properties of entity MaterialsListDB.<br/>
    ...
    public MaterialsListDBDao(DaoConfig config) {
        super(config);
    }
    
    public MaterialsListDBDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MATERIALS_LIST_DB\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MATERIALS_LIST_DB\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MaterialsListDB entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MaterialsListDB entity) {
        stmt.clearBindings();
    ...
    @Override
    public MaterialsListDB readEntity(Cursor cursor, int offset) {
        MaterialsListDB entity = new MaterialsListDB( //
    ...
    @Override
    public void readEntity(Cursor cursor, MaterialsListDB entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MaterialsListDB entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MaterialsListDB entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MaterialsListDB entity) {
