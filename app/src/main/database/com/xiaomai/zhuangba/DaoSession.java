...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(Database db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        enumerateDaoConfig = daoConfigMap.get(EnumerateDao.class).clone();
        enumerateDaoConfig.initIdentityScope(type);
        ...
        enumerateDao = new EnumerateDao(enumerateDaoConfig, this);
        ...
        registerDao(Enumerate.class, enumerateDao);
    }
    ...
    public void clear() {
        ...
        enumerateDaoConfig.clearIdentityScope();
    }
